 ...
 * generated in the com.proinnova.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCitynameResponse_QNAME = new QName("http://webservice.proinnova.com/", "getWeatherByCitynameResponse");
    private final static QName _GetWeatherByCityname_QNAME = new QName("http://webservice.proinnova.com/", "getWeatherByCityname");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.proinnova.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.proinnova.com/", name = "getWeatherByCitynameResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.proinnova.com/", name = "getWeatherByCityname")
